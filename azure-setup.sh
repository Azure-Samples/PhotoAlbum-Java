...
# Azure PostgreSQL Setup Script for PhotoAlbum Application
# This script provisions Azure PostgreSQL and sets up the database for the application

set -e

# Configuration variables
RESOURCE_GROUP_NAME="rg-photoalbum-$(date +%s)"
LOCATION="Central US"
...
if ! az account show &> /dev/null; then
    echo_info "Not logged into Azure. Please log in..."
    az login
fi

echo_info "Starting Azure PostgreSQL setup for PhotoAlbum application..."
