...
public class Photo {
     ...
     */
    @NotNull
    // Migrated from Oracle to PostgreSQL according to java check item 9999: Migrate all other Oracle-specific content to PostgreSQL. For each line, carefully verify whether it uses Oracle-only features.
